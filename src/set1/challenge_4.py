...
# Inspired from https://laconicwolf.com/2018/06/05/cryptopals-challenge-4-detect-single-character-xor-encryption/
...
def main():
    ciphers = open('/Users/akhilz/PycharmProjects/cryptopals/chall4.txt').read().splitlines()
    potential_plaintext = []
...
if __name__ == "__main__":
    values = []
    with open("/Users/akhilz/PycharmProjects/cryptopals/chall4.txt") as f:
        for i, line_with_new_line in enumerate(f.readlines()):
            line = line_with_new_line
